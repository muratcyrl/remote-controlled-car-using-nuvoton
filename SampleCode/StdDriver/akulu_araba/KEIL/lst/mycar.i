# 1 "..\\..\\..\\..\\Library\\StdDriver\\src\\mycar.c"
# 1 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mycar.h"
# 1 "C:\\Keil_v5\\ARM\\Arm_Compiler_5.06u7\\Bin\\..\\include\\stdio.h"
...
# 47 "C:\\Keil_v5\\ARM\\Arm_Compiler_5.06u7\\Bin\\..\\include\\stdio.h"
...
# 136 "C:\\Keil_v5\\ARM\\Arm_Compiler_5.06u7\\Bin\\..\\include\\stdio.h"


extern FILE __stdin, __stdout, __stderr;
extern FILE *__aeabi_stdin, *__aeabi_stdout, *__aeabi_stderr;

# 166 "C:\\Keil_v5\\ARM\\Arm_Compiler_5.06u7\\Bin\\..\\include\\stdio.h"
...
# 1021 "C:\\Keil_v5\\ARM\\Arm_Compiler_5.06u7\\Bin\\..\\include\\stdio.h"



 

# 4 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mycar.h"
...
# 5 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mycar.h"
# 6 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mycar.h"

# 14 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mycar.h"
...
# 2 "..\\..\\..\\..\\Library\\StdDriver\\src\\mycar.c"
# 1 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mymain.h"

# 5 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mymain.h"
# 6 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mymain.h"
# 7 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mymain.h"
# 8 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mymain.h"
# 9 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mymain.h"
# 10 "..\\..\\..\\..\\Library\\StdDriver\\inc\\mymain.h"
int32_t main(void);
void SYS_Init(void);
void UART_Init(void);
# 3 "..\\..\\..\\..\\Library\\StdDriver\\src\\mycar.c"
...
settings *_settings(){
	...
	me->u8IntChar=0xFF;
	me->port=2;
	if(me->duty==0) me->duty=10;
	me->u32IntSts= ((UART_T *) (((uint32_t)0x40000000) + 0x50000))->ISR;
	return me;
}
...
void DETACH_UART(){
	...
	if((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(1))) + ((4)<<2))))==1){
...
void CAR_MANUEL(){
	    ...
	    if((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(1))) + ((4)<<2))))==0){
				 ATTACH_UART();
			}
			                                                                                   
			if((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(1))) + ((5)<<2))))==0){
				PWM_ConfigOutputChannel(((PWM_T *) (((uint32_t)0x40000000) + 0x40000)),car_setting_manuel->port,car_setting_manuel->freq,car_setting_manuel->duty);
				PWM_Start(((PWM_T *) (((uint32_t)0x40000000) + 0x40000)),(1<<2));
			}
			else{
				PWM_Stop(((PWM_T *) (((uint32_t)0x40000000) + 0x40000)),(1<<2));
			}
			                                                                                   
			if((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(3))) + ((4)<<2))))==0){
				car_setting_manuel->duty=70;
			}
			if((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(3))) + ((5)<<2))))==0){
				car_setting_manuel->duty=40;
			}
			if((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(2))) + ((5)<<2))))==0){
...
void CAR_MOVING()
{
    ...
    if(car_setting->u32IntSts & (1ul << 8))
    {
        ...
        {			
				   PWM_ConfigOutputChannel(((PWM_T *) (((uint32_t)0x40000000) + 0x40000)),car_setting->port,car_setting->freq,car_setting->duty);     
           car_setting->u8IntChar = (((UART_T *) (((uint32_t)0x40000000) + 0x50000))->RBR);          
           printf("%c ", car_setting->u8IntChar);
				 ...
				 switch(car_setting->u8IntChar){
					 ...
					 if (car_setting->u8IntChar=='F' || (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(1))) + ((5)<<2))))==0){
						 PWM_Start(((PWM_T *) (((uint32_t)0x40000000) + 0x40000)),(1<<2));
					  }
					 				                                                
					  if(car_setting->u8IntChar=='L'){
							(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(0))) + ((6)<<2))))=0;
							(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(0))) + ((5)<<2))))=1;
						}
						if(car_setting->u8IntChar=='R'){
							(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(0))) + ((6)<<2))))=1;
							(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(0))) + ((5)<<2))))=0;
						}
						                                                    
						if((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(1))) + ((5)<<2))))==1 && car_setting->u8IntChar!='F'){
							PWM_Stop(((PWM_T *) (((uint32_t)0x40000000) + 0x40000)),(1<<2));
						}
