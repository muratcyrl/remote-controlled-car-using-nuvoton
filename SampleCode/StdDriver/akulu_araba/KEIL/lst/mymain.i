# 1 "..\\..\\..\\..\\Library\\StdDriver\\src\\mymain.c"
...
void SYS_Init(void);
void UART_Init(void);
# 3 "..\\..\\..\\..\\Library\\StdDriver\\src\\mymain.c"
...
# 4 "..\\..\\..\\..\\Library\\StdDriver\\src\\mymain.c"
void SYS_Init(void)
{
   SYS_UnlockReg();
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->P1_MFP &= ~(0x00000404UL | 0x00000808UL);
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->P1_MFP |= (0x00000400UL | 0x00000800UL);
		
		((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APBCLK |= (1ul << 21);
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->P2_MFP= 0x00001000UL;
...
void UART_Init()
{
	  ...
	  PWM_EnableOutput(((PWM_T *) (((uint32_t)0x40000000) + 0x40000)),(1<<2));
	  ...
	  GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04080)),(0x00000020),0x1UL);
	  GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04040)),(0x00000020),0x0UL);
	  GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04040)),(0x00000010),0x0UL);
}
